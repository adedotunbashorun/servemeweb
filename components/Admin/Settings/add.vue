        ...
        <div class="panel panel-headline">
          ...
          <div class="panel-body">
            <form @submit.prevent="checkForm">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" v-model="settings.name" placeholder="Name" aria-label="Name" aria-describedby="basic-addon1">
                </div>
  ...
  props:['page'],
    ...
    methods: {
        ...
        checkForm: function (e) {
            if (this.settings.name && this.settings.description) {
            this.register();
            return true;
            }
        ...
        createImage(file) {
          ...
          reader.onload = (e) => {
            vm.settings.image = e.target.result;
          };
